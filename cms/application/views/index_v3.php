...
<head>
    ...
    <link rel="shortcut icon" href="<?=base_url();?>favicon.ico"> <link href="<?=base_url();?>css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
...
<script src="<?=base_url();?>js/demo/sparkline-demo.min.js"></script>
<script>
