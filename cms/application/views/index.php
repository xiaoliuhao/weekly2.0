...
<head>
    ...
    <title>Weekly后台管理系统 - 主页</title>

    <meta name="keywords" content="Weekly后台管理系统,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
    ...
    <link href="<?=base_url();?>css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="<?=base_url();?>css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="<?=base_url();?>css/animate.min.css" rel="stylesheet">
    <link href="<?=base_url();?>css/style.min.css?v=4.0.0" rel="stylesheet">
</head>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="<?=base_url();?>img/profile_small.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<?=site_url('Member');?>">联系人</a>
                        </li>
                        <li><a class="J_menuItem" href="<?=site_url('Member/profile');?>">个人资料</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?=site_url('welcome/index_v3');?>?v=4.0" frameborder="0" data-id="index_v3.php" seamless></iframe>
        </div>
        <div class="footer">
...
<script src="<?=base_url();?>js/plugins/layer/layer.min.js"></script>
<script src="<?=base_url();?>js/hplus.min.js?v=4.0.0"></script>
<script type="text/javascript" src="<?=base_url();?>js/contabs.min.js"></script>
