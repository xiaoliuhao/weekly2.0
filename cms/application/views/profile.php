            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="<?=base_url();?>img/profile_big.jpg">
                    </div>
                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/a1.jpg">
                                </a>
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/a2.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=base_url();?>img/a3.jpg">
                                </a>
                                <div class="media-body ">
...
<script src="<?=base_url();?>js/content.min.js?v=1.0.0"></script>
<script src="<?=base_url();?>js/plugins/peity/jquery.peity.min.js"></script>
<script src="<?=base_url();?>js/demo/peity-demo.min.js"></script>
